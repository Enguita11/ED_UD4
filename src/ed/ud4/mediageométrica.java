...
public class mediageométrica {
    //EJERCICIO 6
    //La media geométrica se calcula aplicando la raíz enésima del producto de los n números que se quieren promediar. Incluiremos este cálculo en nuestro programa. Declararemos la variable que acumula el producto como double para evitar desbordamiento aritmético.
